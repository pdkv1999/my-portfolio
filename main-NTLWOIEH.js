...
var My = (() => {
    ...
    e.\u0275fac = function(i) {
        ...
        template: function(i, o) {
            i & 1 && (g(0, "section", 0)(1, "div", 1)(2, "h2", 2), v(3, "EDUCATION"), h(), g(4, "div", 3)(5, "a", 4), v(6, "University of North Texas"), h(), g(7, "p"), v(8, "Master of Science in Computer Science | June 2024"), h(), g(9, "p")(10, "strong"), v(11, "Relevant Courses: "), h(), v(12, "Computer Networks, Software Engineering, Big Data, "), z(13, "br"), v(14, " Computer Algorithms, Database Management Systems"), h(), g(15, "p")(16, "strong"), v(17, "Experience: "), h(), v(18, "University It Website developer"), h(), g(19, "p")(20, "strong"), v(21, "Extracurricular Activities: "), h(), v(22, "Member of AI Club"), h()(), g(23, "div", 5)(24, "a", 6), v(25, "Sastra University"), h(), g(26, "p"), v(27, "Bachelor of Technology in Electronics and Communication Engineering | May 2020"), h(), g(28, "p")(29, "strong"), v(30, "Relevant Courses: "), h(), v(31, "Data Visulization, Computer Networks, Programming Languages"), h(), g(32, "p")(33, "strong"), v(34, "Achievements: "), h(), v(35, "Recipient of the National Scholarship Scheme and subject topper in VLSI"), h(), g(36, "p")(37, "strong"), v(38, "Extracurricular Activities: "), h(), v(39, "Member of SEEE, Coding Club Member"), h()()()())
        },
        styles: ["#education[_ngcontent-%COMP%]{background:#000;background-size:cover;padding:7em;text-align:center;font-family:Montserrat,sans-serif}#education[_ngcontent-%COMP%]   .education-item[_ngcontent-%COMP%]{background-color:#8a81811a;padding:20px;margin-bottom:20px;border-radius:10px}#education[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{font-size:1.2em;color:#ffbd39;font-weight:700;text-decoration:none;padding-top:18px;display:inline-block}#education[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover{color:#ffbd39}#education[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{color:#ffbd39;margin-bottom:30px}#education[_ngcontent-%COMP%]   .container[_ngcontent-%COMP%]{color:#999}@media screen and (max-width: 1024px){#education[_ngcontent-%COMP%]{padding:5em}#education[_ngcontent-%COMP%]   .education-item[_ngcontent-%COMP%]{padding:15px}}@media screen and (max-width: 768px){#education[_ngcontent-%COMP%]{padding:3em}#education[_ngcontent-%COMP%]   .education-item[_ngcontent-%COMP%]{padding:15px;border-radius:1.5rem}#education[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{font-size:1.1em;padding-top:15px}}@media screen and (max-width: 480px){#education[_ngcontent-%COMP%]{padding:2em}#education[_ngcontent-%COMP%]   .education-item[_ngcontent-%COMP%]{padding:10px;border-radius:1rem;margin-bottom:14px}#education[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]{font-size:1em;padding-top:12px}#education[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{font-size:1.5em;margin-bottom:20px}}"]
    });
    let t = e;
    return t
})();
...
var xy = (() => {
    ...
    e.\u0275fac = function(i) {
        ...
        template: function(i, o) {
            i & 1 && (g(0, "section", 0)(1, "div", 1)(2, "h2", 2), v(3, "TECHNICAL SKILLS"), h(), g(4, "div", 3)(5, "div", 4)(6, "div", 5)(7, "h3"), v(8, "Programming Languages"), h(), g(9, "p"), v(10, "Java, C++, JavaScript, Es6+, TypeScript, Nodejs, Python"), h()()(), g(11, "div", 4)(12, "div", 5)(13, "h3"), v(14, "Technologies/Frameworks"), h(), g(15, "p"), v(16, "Spring, Spring Boot, RESTful APIs, Hibernate, Angular, AngularJS, ReactJs, ExpressJs, Cucumber, Thymeleaf, Drupal, CI/CD, Aws"), h()()(), g(17, "div", 6)(18, "div", 5)(19, "h3"), v(20, "Knowledge In"), h(), g(21, "p"), v(22, "Maven, Gradle, Spring Security, OAuth2, Splunk, Swagger, Microservices, Kafka, Docker, Selenium, Json, GraphQL, gRPC, Xml, Html, Css, SASS, Agile, Bootstrap, Jsp"), h()()(), g(23, "div", 4)(24, "div", 5)(25, "h3"), v(26, "Databases"), h(), g(27, "p"), v(28, "Oracle, MySQL, MongoDB, Redis, Solr"), h()()(), g(29, "div", 6)(30, "div", 5)(31, "h3"), v(32, "Other Tools"), h(), g(33, "p"), v(34, "Git, GitLab, Svn, Jira, HP-Fortify, ServiceNow, Jenkins, Postman, Eclipse, STS, IntelliJ, Visual Studio, Tomcat, Kibana, Scalyr, UCD, Kubernetes, SonarQube, MS-Office "), h()()(), g(35, "div", 6)(36, "div", 7)(37, "h3"), v(38, "Operating Systems"), h(), g(39, "p"), v(40, "Linux, Windows, Android"), h()()()()()())
        },
        styles: [".skills[_ngcontent-%COMP%]{background:linear-gradient(to top,beige,#fff8dc);background:#000;padding:4em;display:flex;flex-direction:column;align-items:center;animation:fadeIn 2s ease-in;font-family:Montserrat}.skills[_ngcontent-%COMP%]   .row[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;justify-content:center;gap:2em}.skills[_ngcontent-%COMP%]   .skill-item[_ngcontent-%COMP%]{background:#8a81811a;padding:20px;border-radius:15px;margin-bottom:20px;box-shadow:0 2px 5px #0000001a;display:flex;font-family:Montserrat;flex-direction:column;align-items:center;width:100%;max-width:350px}.skills[_ngcontent-%COMP%]   .skill-item[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%]{color:#ffbd39}.skills[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%]{color:#ffbd39;text-align:center;font-size:1.5em}.skills[_ngcontent-%COMP%]   .skill-item[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{color:#999}"]
    });
    let t = e;
    return t
})();
    ...
    let e = class e {
        constructor() {
            this.experienceItems = [{
                ...
                details: ["Created and customized 15+ dynamic Angular components and downgraded them to utilize in AngularJS pages.", "Part of defect pod which was responsible for doing critical bug fixes and deliver in short time (weekly releases) resulted in 40% reduction in escalation tickets.", "Executed secure license uploads & robust search feature, leveraging Angular, TypeScript, RESTful APIs & Spring Boot.", "Rendered multiple pages in UI, loading the scripts through the content management system (Drupal).", "Generated BDD automation scripts for UI and performed E2E tests which reduced defects by 60%.", "Revamped Lot Details pages for legacy application to Angular 12. Utilized Angular, JavaScript, CSS, HTML, Spring Boot, Bootstrap, REST APIs, and MySQL, resulting UI enhancement & functionalities for the clients.", "Broadcasted events to Google Analytics (GTM), leading to a 35% increase in actionable insights. This enabled the marketing team to refine campaign targeting strategies, driving a 20% increase in product sales."],
                delay: 200
            }, {
                ...
                details: ["Worked on spike, stories, and defects for the product Revenue Cycle, which involved assessing the interaction between multiple systems and API/design changes required to implement new features.", "Addressed HP-Fortify, SonarQube vulnerability issues, enhancing code quality by 30% and reducing security risks. Utilized Splunk to visualize logs, enabling proactive monitoring and rapid issue identification.", "Designed and developed a feature Visit List Filter Queue, which prioritized patient encounters based on their appointment dates and emergencies, and integrated it into Revenue Cycle.", "Worked on Jira integration, where the data in Excel is parsed and corresponding Jira\u2019s are updated, resulting in a 75% increase in communication, collaboration, and adoption across cross-functional teams.", "Migrated APIs from synchronous to asynchronous using Spring Reactive Programming, optimizing system performance by 50%, and deployed them using Jenkins pipeline for Continuous Integration and Delivery.", "Performed unit testing using Junit, achieving 85%+ coverage, and utilized Postman for backend testing, while also participating in code reviews.", "Delivered APIs for fetching EHR data to Cerner Millennium, resulting in a 30% increase in order processing efficiency.", "Implemented Apache Kafka in Java for efficient application log processing and real-time email notifications, enhancing system monitoring capabilities and user engagement."],
                delay: 300
            }, {
                ...
                details: ["Developed Object-Oriented Fullstack Applications and REST APIs using Java 8 functional programming, adhering to SOLID principles and implementing design patterns.", "Implemented user-friendly web login functionality and highly secure microservices-based REST APIs for IMMS Consumer Services using Java Spring Boot. Included the generation of JWT tokens, improving user access security by 35%.", "Built an automation tool named Bidirectional Trace Validation, which crawls the JAMA & SVN websites to capture the requirement numbers, significantly reducing the team's manual effort by 30 hours during release activity.", "Day To Day Work: Worked with Flight Management System and Flight User Interface teams, mostly improving the consistency and efficiency of enterprise applications, and was involved in Continuous Build and Test (CBT)."],
                delay: 400
            }]
        }
        ngOnInit() {
